...
def get_model_info(model: nn.Module, tsize: Sequence[int], input_channels: int = 3) -> str:
    from thop import profile

    stride = 64
    img = torch.zeros((1, input_channels, stride, stride), device=next(model.parameters()).device)
